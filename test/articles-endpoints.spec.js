...
const maliciousArticle = require('./articles-mailicious.fixtures')
...
describe('GET /api/articles', function(){
   ...
   context(`Given no articles`, ()=>{
    ...
    context('Given there are articles in the database', () => {
      ...
      context('Given there are malicious articles in the database, returns sanitized article', ()=>{
...
describe(`POST /api/articles`, ()=>{
 ...
 it(`responds with 201 and sanitizes response given malicious article`, () =>{
   delete maliciousArticle.id
   return supertest(app)
   .post('/api/articles')
